...
RESOURCES = [
    ...
    package_build.Resource('binaries', '{vs_build_output}/delta-basic-engine.pdb', '{output}/lib/{architecture}/{configuration}', resource_type='file'),
    ...
    package_build.Resource('binaries', '{vs_build_output}/delta-physics.pdb', '{output}/lib/{architecture}/{configuration}', resource_type='file'),
    ...
    package_build.Resource('binaries', '{vs_build_output}/delta-core.pdb', '{output}/lib/{architecture}/{configuration}', resource_type='file'),
