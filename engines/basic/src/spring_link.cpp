...
int dbasic::SpringLink::GenerateCollisions(Collision *collisionArray) {
...
void dbasic::SpringLink::DrawDebug(DeltaEngine *engine, int layer) {
    int red[3] = { 255, 0, 0 };
    int blue[3] = { 0, 0, 255 };
