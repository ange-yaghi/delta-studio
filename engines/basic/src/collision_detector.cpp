...
dbasic::CollisionDetector::CollisionDetector() {
    /* void */
}
...
bool dbasic::CollisionDetector::CircleCircleIntersect(RigidBody *body1, RigidBody *body2, CirclePrimitive *circle1, CirclePrimitive *circle2) {
...
bool dbasic::CollisionDetector::BoxBoxCollision(Collision &collision, RigidBody *body1, RigidBody *body2, BoxPrimitive *box1, BoxPrimitive *box2) {
...
bool dbasic::CollisionDetector::CircleCircleCollision(Collision &collision, RigidBody *body1, RigidBody *body2, CirclePrimitive *circle1, CirclePrimitive *circle2) {
...
bool dbasic::CollisionDetector::_BoxBoxCollision(Collision *collision, BoxPrimitive *body1, BoxPrimitive *body2) {
    bool ret = false;
...
bool dbasic::CollisionDetector::_BoxBoxEdgeDetect(Collision *collisions, BoxPrimitive *body1, BoxPrimitive *body2) {
    bool ret = false;
