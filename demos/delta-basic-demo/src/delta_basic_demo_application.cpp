...
void delta_demo::DeltaBasicDemoApplication::Initialize(void *instance, ysContextObject::DeviceAPI api) {
    m_engine.GetConsole()->SetDefaultFontDirectory(L"../../../engines/basic/fonts/");

    dbasic::DeltaEngine::GameEngineSettings settings;
    settings.API = api;
    settings.DepthBuffer = true;
    settings.Instance = instance;
    settings.ShaderDirectory = L"../../../engines/basic/shaders/";
    settings.WindowTitle = L"Delta Basic Engine - Demo Application";
    ...
    m_assetManager.CompileInterchangeFile(L"../../../test/geometry_files/ant_rigged", 1.0f, true);
    m_assetManager.LoadSceneFile(L"../../../test/geometry_files/ant_rigged");
    ...
    m_assetManager.LoadAnimationFile(L"../../../test/animation_files/ant_rigged.dimo");
